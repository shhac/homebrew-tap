class CrewAssistant < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/shhac/crew-assistant/releases/download/v0.10.0/agent-assistant-darwin-arm64.tar.gz"
      sha256 "eeb65950ce3bb7ee44c5cc675c433480ae7942857e6b5a4123241449ed721a18"
    end
    on_intel do
      url "https://github.com/shhac/crew-assistant/releases/download/v0.10.0/agent-assistant-darwin-amd64.tar.gz"
  ...
  on_linux do
    on_arm do
      url "https://github.com/shhac/crew-assistant/releases/download/v0.10.0/agent-assistant-linux-arm64.tar.gz"
      sha256 "4dc1b8fa53e732bba86365a099fa1bd80e4d503865c57680c91e30dd654eac71"
    end
    on_intel do
      url "https://github.com/shhac/crew-assistant/releases/download/v0.10.0/agent-assistant-linux-amd64.tar.gz"
